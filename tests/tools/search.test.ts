...
beforeEach(() => {
  ...
  writeFileSync(join(WIKI_DIR, "attention.md"), "---\ntitle: Attention\n---\n\nAttention is a mechanism in deep learning.", "utf-8");
  writeFileSync(join(WIKI_DIR, "bert.md"), "---\ntitle: BERT\n---\n\nBERT uses bidirectional attention.", "utf-8");
});
